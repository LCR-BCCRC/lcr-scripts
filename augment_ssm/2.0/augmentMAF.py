...
The original script is augment_ssm by many authors. So here we attempted to create a simplified version that is more
readable and maintainable. And to make it easier to incorporate into other pipelines or scripts the code was wrapped
into a custom class, and a CLI was added. The core logic on what the script does is the same, just
